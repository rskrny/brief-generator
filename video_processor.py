...
# Define the paths to our local executables
...
def download_video(video_url):
    ...
    try:
        ydl_opts = {
            ...
            'yt_dlp_path': YT_DLP_PATH,    # Tell the library which yt-dlp to use
        }
    ...
    for i, ts in enumerate(timestamps):
        ...
        try:
            (
                ...
                .overwrite_output()
                .run(cmd=FFMPEG_PATH, quiet=True) # Tell ffmpeg-python which exe to run
            )
